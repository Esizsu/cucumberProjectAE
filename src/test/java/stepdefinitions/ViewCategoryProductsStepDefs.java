...
//        List<WebElement> category = Driver.getDriver().findElements(By.xpath("//div[@class='panel-group category-products']"));
//        boolean isAllDisplayed = true;
//        for (WebElement categoryList : category) {
//            if (categoryList.isDisplayed() == false) {
